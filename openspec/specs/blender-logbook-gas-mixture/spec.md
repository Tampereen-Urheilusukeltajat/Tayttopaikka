# Spec: Blender Logbook Gas Mixture

## Purpose

The Happihäkki (blender logbook) form lets blenders select the gas mixture being filled (Nitrox, Trimix, Argon, or Oxygen). The selected mixture drives default percentages, which fields are editable, which storage cylinders are offered, and whether diluent-bank filling is available.
